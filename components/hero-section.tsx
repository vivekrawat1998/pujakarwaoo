...
export function HeroSection() {
  return (
    <div className="relative min-h-[calc(100vh-7.5rem)] flex items-center justify-center pt-20">
      ...
      <div className="relative  z-10 text-center px-4 max-w-4xl mx-auto">
        <h1 className="text-3xl sm:text-4xl md:text-6xl font-bold mb-4 text-[#FEBD02]">
        ...
        <div className="flex flex-col sm:flex-row max-w-3xl mx-auto bg-white rounded-lg overflow-hidden shadow-lg">
          ...
          <Input
            ...
            className="flex-1 md:py-6 py-3 items-center justify-center border-0 focus-visible:ring-0 text-base"
          />
          <Button className="rounded-none  px-8 py-6 bg-[#FEBD02] hover:bg-[#e6a600] text-black font-medium text-lg w-full sm:w-auto">
            Search
          </Button>
        </div>
      </div>
